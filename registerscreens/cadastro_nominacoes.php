...
<head>
    ...
    <script src="../dinamicfunctions/nominacoes_pessoas.js"></script>
</head>
<body>
                ...
                <div class="col-6">
                    ...
                    <form method="post" action="../services/nominacoes_services.php">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="select-filme" class="form-control" id="filme" name="filme" onchange="carregarPessoas()" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="select-pessoa" class="form-control" id="pessoa" name="pessoa" disabled>
                                <option value="">Selecione o filme primeiro</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
